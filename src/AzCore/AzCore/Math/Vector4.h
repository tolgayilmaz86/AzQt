...
namespace AZ
{
    ...
    public:
        ...
        //! @{
        Vector4 GetNormalizedSafe(float tolerance = 0.001f) const;
        Vector4 GetNormalizedSafeEstimate(float tolerance = 0.001f) const;
        ...
        bool IsClose(const Vector4& v, float tolerance = 0.001f) const;
