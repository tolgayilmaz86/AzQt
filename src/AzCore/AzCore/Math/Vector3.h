...
namespace AZ
{
    ...
    public:
        ...
        //! @{
        Vector3 GetNormalizedSafe(float tolerance = 0.001f) const;
        Vector3 GetNormalizedSafeEstimate(float tolerance = 0.001f) const;
        void NormalizeSafe(float tolerance = 0.001f);
        void NormalizeSafeEstimate(float tolerance = 0.001f);
        float NormalizeSafeWithLength(float tolerance = 0.001f);
        float NormalizeSafeWithLengthEstimate(float tolerance = 0.001f);
        //! @}
        ...
        bool IsClose(const Vector3& v, float tolerance = 0.001f) const;
        ...
        bool IsPerpendicular(const Vector3& v, float tolerance = 0.001f) const;
