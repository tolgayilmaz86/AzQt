...
namespace AzQtComponents
{
    ...
    void StyleManager::addSearchPaths(const QString& searchPrefix, const QString& pathOnDisk, const QString& qrcPrefix,
                                      const std::string_view &engineRootPath)
    {
        if (!s_instance)
        {
    ...
    void StyleManager::initialize([[maybe_unused]] QApplication *application,
                                  const std::string_view &engineRootPath)
    {
        if (s_instance)
        {
    ...
    void StyleManager::initializeSearchPaths(
        ...
        const std::string_view &engineRootPath)
    {
        ...
        QString rootDir = QString::fromUtf8(engineRootPath.data(), static_cast<int>(engineRootPath.size()));
