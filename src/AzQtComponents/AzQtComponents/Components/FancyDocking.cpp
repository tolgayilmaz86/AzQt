...
namespace AzQtComponents
{
    ...
    void FancyDocking::setupDropZones(QWidget* dock, const QPoint& globalPos)
    {
        ...
        */
        ...
        {
            dropZoneWidth = static_cast<int>(dockWidth * FancyDockingDropZoneConstants::dropZoneScaleFactor);
        }
        ...
        {
            dropZoneHeight = static_cast<int>(dockHeight * FancyDockingDropZoneConstants::dropZoneScaleFactor);
        }
        ...
        centerDropZoneDiameter = static_cast<int>(
            centerDropZoneDiameter *
            FancyDockingDropZoneConstants::centerTabDropZoneScale);
...
// TODO
            if (fromScreen != toScreen)
            {
                ...
                placeholderRect.setWidth(static_cast<int>(
                    static_cast<qreal>(placeholderRect.width()) *
                    factorRatio));
                placeholderRect.setHeight(static_cast<int>(
                    static_cast<qreal>(placeholderRect.height()) *
                    factorRatio));
            }
