    ...
    : QWidget(widget)
{
    ...
    m_redSlider->setColorFunction([this](qreal position) {
        return toQColor(static_cast<float>(position),
                        static_cast<float>(m_greenSlider->value()),
                        static_cast<float>(m_blueSlider->value()));
    });
    ...
    m_greenSlider->setColorFunction([this](qreal position) {
        return toQColor(static_cast<float>(m_redSlider->value()),
